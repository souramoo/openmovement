...
For a richer analysis, a popular option in research is the open source [GGIR](https://wadpac.github.io/GGIR/) software, which includes sleep analysis and can also produce more visual reports.  A good introduction to the package is given in:
[What is GGIR](https://wadpac.github.io/GGIR/articles/chapter1_WhatIsGGIR.html) and [GGIR: A Research Community–Driven Open Source R Package for Generating Physical Activity and Sleep Outcomes From Multi-Day Raw Accelerometer Data](https://journals.humankinetics.com/view/journals/jmpb/2/3/article-p188.xml), and a [GGIR: Get Started](https://wadpac.github.io/GGIR/articles/chapter0_GetStarted.html) guide is available. <!-- [Accelerometer data processing with GGIR](https://cran.r-project.org/web/packages/GGIR/vignettes/GGIR.html) -->  Step counting can be [added as an external function](https://cran.r-project.org/web/packages/GGIR/vignettes/ExternalFunction.html): [Verisense Step Count Algorithm for GGIR](https://github.com/ShimmerEngineering/Verisense-Toolbox/tree/master/Verisense_step_algorithm). 
